...
const ForwardOnlyStrictArgs = Object.assign(Object.assign({}, ForwardPaginateArgs), { first: nonNull_1.nonNull(args_1.intArg({ description: 'Returns the first n elements from the list.' })) });
...
const BackwardOnlyStrictArgs = Object.assign(Object.assign({}, BackwardPaginateArgs), { last: nonNull_1.nonNull(args_1.intArg({ description: 'Returns the last n elements from the list.' })) });
