...
The field-level customization approach will result in a custom connection type specific to that type/field, e.g. `QueryUsersConnection`, since the modification is specific to the individual field.
